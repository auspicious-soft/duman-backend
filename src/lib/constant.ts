...
//     ];
export const badges = [
      { count: 1, badge: "Saint", level: 1 },
      { count: 2, badge: "Hakim", level: 2 },
      { count: 3, badge: "Genius", level: 3 },
      { count: 4, badge: "Teacher" , level: 4 },
      { count: 5, badge: "Sufi", level: 5 },
      { count: 6, badge: "Expert", level: 6 },
      { count: 7, badge: "Commentator", level: 7 },
      { count: 8, badge: "Dervish", level: 8 },
      { count: 9, badge: "Murid", level: 8 },
    ];
