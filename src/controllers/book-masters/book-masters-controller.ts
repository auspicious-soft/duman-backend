...
import { createBookMasterService, getBookMasterService, updateBookMasterService, deleteBookMasterService, getAllBookMastersService } from "../../services/book-masters/book-masters-service";
import { errorParser } from "../../lib/errors/error-response-handler";
import { httpStatusCode } from "../../lib/constant";

export const createBookMaster = async (req: Request, res: Response) => {
    try {
        const response = await createBookMasterService(req.body, res);
